    ...
    <>
      <div className='bg-[#8EB226] flex justify-between px-5 py-4  '>
        ...
        <div className="flex gap-2  items-center">
          ...
          <img src='/images/title-logo.png' alt='logo-title' className='w-24' />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="lg:hidden block " onClick={() => setIsOpen(true)}>
            <img src="public/icons/menu.png" alt="menu" className=" w-7 h-7" />
          </div>
        </div>
      </div>
      {isOpen && <MobNav isOpen={setIsOpen} />}
    </>
